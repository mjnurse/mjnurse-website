...
The alias file contains:
 ...
 - Shortcut alias commands generated by the CLI builder.

 - A CLI command completer for the shortcut commands where one is defined in the CLI definition file.
...
The CLI bash script is generated by the CLI builder based on the definition file. This is the CLI implementation.
